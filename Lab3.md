...
![](media/image1.png){width="3.7291666666666665in"
height="1.8472222222222223in"} s2.setCgpa(3.92);
...
}else System.out.println(\"Invalid Amount!.Please Deposit Correct
Amount\");
...
}else System.out.println(\"Icorrect amount!. use your brain\");
...
![](media/image2.png){width="4.493055555555555in"
...
if(car2.getPrice()\>car1.getPrice()&&car2.getPrice()\>car3.getPrice())

System.out.println(\"Most Expensive Car : Car 2\");

else System.out.println(\"Most Expensive Car : Car 3\");

}

![](media/image3.png){width="4.298611111111111in"
...
}![](media/image4.png){width="3.3402777777777777in"
...
![](media/image5.png){width="4.208333333333333in"
